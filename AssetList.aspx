...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Add New  Assets" OnClick="Button1_Click" />
    ...
    <asp:GridView ID="GridView1" DataKeyNames="Id" runat="server" AutoGenerateColumns="False" Width="629px" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton class="btnrowvalue1" ID="LinkButton1" Text="Edit" runat="server" CommandName="Select" OnClick="LinkButton1_Click" />
